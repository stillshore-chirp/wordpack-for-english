...
- 既定値:
  - env.example: `LLM_PROVIDER=openai`, `LLM_MODEL=gpt-5.6-luna`, `LLM_TIMEOUT_MS=45000`, `LLM_MAX_RETRIES=1`, `LLM_MAX_TOKENS=1500`
  - コード既定: `llm_provider="openai"`, `llm_model="gpt-5.6-luna"`, `llm_timeout_ms=60000`, `llm_max_retries=1`, `llm_max_tokens=900`
- 使われ方:
  - プロバイダ選択と初期化
