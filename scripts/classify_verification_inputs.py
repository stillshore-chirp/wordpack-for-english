...
PATH_RULES: tuple[PathRule, ...] = (
    ...
    _rule(
        "deploy_artifact_builder",
        "deploy",
        "artifact_supply_chain",
        gates={"backend_container", "deploy_preflight", "workflow_contract"},
        exact={"scripts/build_backend_artifact.sh"},
    ),
    _rule(
        "deploy_artifact_verifier",
        "deploy",
        "artifact_supply_chain",
        gates={"backend_container", "deploy_preflight", "workflow_contract"},
        exact={"scripts/verify_backend_artifact_attestations.sh"},
    ),
    _rule(
