...
require_block_text "docs/agent-harness.md" "## GitHub reviewの収束" "review-convergence" "配送対象の最終HEADに対する初回レビュー1回と、指摘修正後の再レビュー1回までを原則とする"
...
require_block_text "docs/agent-harness.md" "## GitHub reviewの収束" "review-convergence" "3回目以降の包括レビューは実行しません"
